...
CREATE TABLE `book` (
  ...
  `image_url` varchar(255) DEFAULT NULL,
  `book_status` enum('AVAILABLE','RESERVED','BORROWED') DEFAULT NULL,
  `category` enum('CRIME','HORROR','THRILLER','CLASSIC','LOVE','SCIENCE','FANTASY','CHILDREN','BIOGRAPHY','POETRY','COOK_BOOKS','HISTORY','IT','LANGUAGE') NOT NULL,
  PRIMARY KEY (`book_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-06-07 14:09:48
